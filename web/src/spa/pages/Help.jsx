...
const FAQ = [
  ['How is the threat score calculated?', 'Seven analyzers each emit evidence (header forensics, SPF/DKIM/DMARC, NLP content, network, domain, campaign correlation, and sender footprint). A single explainable weight table combines them into a 0–100 score and a band. Every point is traceable in the AI Analysis Breakdown.'],
